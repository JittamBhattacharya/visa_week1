...
public class ProductClient {
	...
	public static void main(String[] args) {
		...
		products[1] = new Mobile(453, "MotoG", 12999.99, "4G");
		products[2] = new Tv(634, "Onida Thunder", 3500.00, "CRT");
		products[3] = new Mobile(621, "iPhone XR", 99999.99, "4G");
	...
	/**
	 * Print details using Open foe Extension , Closed for Change Done using
	 * Reflection API
	 * 
	 * @param products
	 */
